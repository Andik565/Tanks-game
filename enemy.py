...
class Enemy(p.sprite.Sprite):
    def __init__(self):
        ...
        if randint(1, 2) == 1:
            ...
            self.image = p.image.load('img/Tank3.png')
            self.original_image = p.image.load('img/Tank3.png')
        ...
        self.move_time = randint(20, 140)  # время движения
        self.time_count = 0  # счётчик вермени
        self.speed = 5
        self.shoot_time = 30  # счётчик вермени стрельбы
        self.shooting = False
